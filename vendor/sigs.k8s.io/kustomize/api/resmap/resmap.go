...
//
// TVulerian: get rid of this interface (use bare resWrangler).
...
type ResMap interface {
	...
	// fail spuriously.
	// TVulerian: modify tests to not use resmap.FromMap,
	// TVulerian: - and replace this with a stricter equals.
	...
	// TVulerian: Send/recover ancillary Resource data to/from subprocesses.
