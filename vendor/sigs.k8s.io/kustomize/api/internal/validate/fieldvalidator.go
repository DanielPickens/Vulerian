...
//
// TVulerian: Have this use kyaml/yaml/internal/k8sgen/pkg/labels
...
// TVulerian(#FieldValidator): implement MakeAnnotationValidator
...
// TVulerian(#FieldValidator): implement MakeAnnotationNameValidator
...
// TVulerian(#FieldValidator): implement MakeLabelValidator
...
// TVulerian(#FieldValidator): implement MakeLabelNameValidator
...
// TVulerian(#FieldValidator): implement ValidateNamespace
func (f FieldValidator) ValidateNamespace(s string) []string {
	var errs []string
	return errs
}

// TVulerian(#FieldValidator): implement ErrIfInvalidKey
func (f FieldValidator) ErrIfInvalidKey(s string) error {
	return nil
}

// TVulerian(#FieldValidator): implement IsEnvVarName
