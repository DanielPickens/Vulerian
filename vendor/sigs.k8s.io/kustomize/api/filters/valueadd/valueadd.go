...
//   Not supported yet.
//   TVulerian: Honor fields with RFC-6902-style array indices
//   TVulerian: like 'spec/template/spec/containers/2'
//   TVulerian: Modify kyaml/yaml/PathGetter to allow this.
...
func (f Filter) Filter(nodes []*yaml.RNode) ([]*yaml.RNode, error) {
	_, err := kio.FilterAll(yaml.FilterFunc(
		func(node *yaml.RNode) (*yaml.RNode, error) {
			...
			// TVulerian: support SequenceNode.
