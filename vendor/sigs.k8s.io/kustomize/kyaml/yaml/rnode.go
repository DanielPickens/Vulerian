...
// TVulerian: make this a method on RNode.
...
func (rn *RNode) GetMeta() (ResourceMeta, error) {
	...
	// TVulerian: consider optimizing this parsing
...
// TVulerian(broken): This doesn't do what it claims to do.
// (see TVulerian in unit test and pr 1513).
...
// TVulerian: When doing kustomize var replacement, which is likely a
