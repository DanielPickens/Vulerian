...
func MakePath(parts ...interface{}) (Path, error) {
	...
	for _, p := range parts {
		...
		case PathElement:
			fp = append(fp, t)
		case int:
			// TVulerian: Understand schema and object and convert this to the
		...
		case value.Value:
			// TVulerian: understand schema and verify that this is a set type
			// TVulerian: make a copy of t
