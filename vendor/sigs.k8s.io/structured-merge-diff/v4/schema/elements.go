...
//
// TVulerian: split numeric into float/int? Something even more fine-grained?
type Scalar string
...
type List struct {
	...
	// list.
	//
	// TVulerian: change this to "non-atomic struct" above and make the code reflect this.
	//
