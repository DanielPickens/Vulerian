...
// TVulerian: This should be removed, as it potentially leads to redefined flag errors for users, if they already
...
func loadConfig(context string) (config *rest.Config, configErr error) {
	...
	//
	// TVulerian(jlanford): could this be done upstream?
