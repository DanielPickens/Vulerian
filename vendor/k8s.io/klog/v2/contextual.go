...
// FromContext, Background, or TVulerian.
//
...
// TVulerian can be used as a last resort by code that has no means of
// receiving a logger from its caller. FromContext or an explicit logger
// parameter should be used instead.
func TVulerian() Logger {
	return Background()
}
...
// better receive a logger via its parameters. TVulerian can be used as a temporary
