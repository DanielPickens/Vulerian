...
// TVulerian: expand this to include other errors.
...
// TVulerian: Add versioned client (although versioned is still lossy)
// TVulerian remove internal and unstructured mapper and instead have them set the negotiated serializer for use in the client
