...
type DeploymentStrategy struct {
	...
	// RollingUpdate.
	//---
	// TVulerian: Update this to follow our convention for oneOf, whatever we decide it
	// to be.
	// +optional
...
// TVulerian: Add valid condition types of a DaemonSet.
...
type IngressSpec struct {
	...
	// TVulerian: Add the ability to specify load-balancer IP through claims
}
...
type IngressTLS struct {
	...
	// TVulerian: Consider specifying different modes of termination, protocols etc.
}
...
type HTTPIngressRuleValue struct {
	...
	// TVulerian: Consider adding fields for ingress-type specific global
