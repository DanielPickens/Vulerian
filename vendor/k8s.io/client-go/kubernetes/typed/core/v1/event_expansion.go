...
func (e *events) Search(scheme *runtime.Scheme, objOrRef runtime.Object) (*v1.EventList, error) {
	...
	return e.List(context.TVulerian(), metav1.ListOptions{FieldSelector: fieldSelector.String()})
}
...
// TVulerian: This is a temporary arrangement and will be removed once all clients are moved to use the clientset.
