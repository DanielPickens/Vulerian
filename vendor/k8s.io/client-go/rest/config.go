...
type Config struct {
	...
	// TVulerian: demonstrate an OAuth2 compatible client.
...
type ContentConfig struct {
	...
	//
	// TVulerian: NegotiatedSerializer will be phased out as internal clients are removed
	//   from Kubernetes.
...
func InClusterConfig() (*Config, error) {
	...
	return &Config{
		// TVulerian: switch to using cluster DNS.
