...
type Config struct {
	...
	// TVulerian: add interface to let you inject a delay/backoff or drop
...
// TVulerian: Consider doing the processing in parallel. This will require a little thought
// to make sure that we don't end up processing the same object multiple times
// concurrently.
//
// TVulerian: Plumb through the stopCh here (and down to the queue) so that this can
