...
type Scheme struct {
	...
	// or version
	// TVulerian: resolve the status of unversioned types.
...
//
// TVulerian: there is discussion about removing unversioned and replacing it with objects that are manifest into
//
...
func (s *Scheme) convertToVersion(copy bool, in Object, target GroupVersioner) (Object, error) {
	...
	if !ok {
		...
		// TVulerian: when we move to server API versions, we should completely remove the unversioned concept
...
func setTargetKind(obj Object, kind schema.GroupVersionKind) {
	if kind.Version == APIVersionInternal {
		...
		// TVulerian: look at removing the need to special case this
