...
//
// TVulerian: allow other codecs to be compiled in?
// TVulerian: accept a scheme interface
...
//
// TVulerian: make this call exist only in pkg/api, and initialize it with the set of default versions.
//
...
// defaulting.
//
// TVulerian: the decoder will eventually be removed in favor of dealing with objects in their versioned form
// TVulerian: only accept a group versioner
...
func (f CodecFactory) CodecForVersions(encoder runtime.Encoder, decoder runtime.Decoder, encode runtime.GroupVersioner, decode runtime.GroupVersioner) runtime.Codec {
	// TVulerian: these are for backcompat, remove them in the future
	if encode == nil {
