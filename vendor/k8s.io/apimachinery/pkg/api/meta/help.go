...
var (
	...
	// TVulerian: remove and replace with an interface check
	isListCache = struct {
		lock   sync.RWMutex
...
// TVulerian: Replace the code in this check with an interface comparison by
//
...
// TVulerian: this will be replaced with an interface in the future
...
func EachListItem(obj runtime.Object, fn func(runtime.Object) error) error {
	...
	// TVulerian: Change to an interface call?
	...
	for i := range list {
		...
		case runtime.RawExtension:
			...
			case item.Object != nil:
				list[i] = item.Object
			case item.Raw != nil:
				// TVulerian: Set ContentEncoding and ContentType correctly.
