...
// TVulerian: move everything in this file to pkg/api/rest
package meta
...
//
// TVulerian: Only accept plural for some operations for increased control?
...
func NewDefaultRESTMapper(defaultGroupVersions []schema.GroupVersion) *DefaultRESTMapper {
	...
	// TVulerian: verify name mappings work correctly when versions differ
...
// TVulerian eliminate this so that different callers can correctly map to resources.  This probably means updating all
