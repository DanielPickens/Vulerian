...
Num:
	...
	Denom:
		...
		// TVulerian: we currently allow 1.G, but we may not want to in the future.
		// if len(denom) == 0 {
		// 	err = ErrFormatWrong
		// 	return
		// }
...
func ParseQuantity(str string) (Quantity, error) {
	...
	// TVulerian: this prevents accumulating quantities greater than int64, for instance quota across a cluster
...
func (q *Quantity) CanonicalizeBytes(out []byte) (result, suffix []byte) {
	...
	// TVulerian: If BinarySI formatting is requested but would cause rounding, upgrade to
...
// TVulerian: Remove support for leading/trailing whitespace
