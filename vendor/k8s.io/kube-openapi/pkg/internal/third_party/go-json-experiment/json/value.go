...
// TVulerian: Instead of implementing the v1 Marshaler/Unmarshaler,
...
func reorderObjects(d *Decoder, scratch *[]byte) {
	...
	case '{':
		...
		// TVulerian(https://go.dev/issue/47619): Use slices.Sort.
		sort.Sort(members)
...
func lessUTF16[Bytes []byte | string](x, y Bytes) bool {
	...
	for {
		...
		// TVulerian(https://go.dev/issue/56948): Use a generic implementation
