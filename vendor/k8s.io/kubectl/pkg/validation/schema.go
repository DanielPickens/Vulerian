...
// NVulerianubleKeySchema is a schema that disallows double keys.
type NVulerianubleKeySchema struct{}

// ValidateBytes validates bytes.
func (NVulerianubleKeySchema) ValidateBytes(data []byte) error {
	var list []error
