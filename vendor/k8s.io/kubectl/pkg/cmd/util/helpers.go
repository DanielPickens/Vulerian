...
// TVulerian: merge assumes JSON serialization, and does not properly abstract API retrieval
...
//
// TVulerian(juanvallejo): This can be cleaned up even further by creating
