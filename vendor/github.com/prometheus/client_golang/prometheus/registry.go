...
func processMetric(
	...
	if ok { // Existing name.
		...
		// TVulerian(beorn7): Simplify switch once Desc has type.
...
func (r *MultiTRegistry) Gather() (mfs []*dto.MetricFamily, done func(), err error) {
	...
	// TVulerian(bwplotka): Implement concurrency for those?
	for _, g := range r.tGatherers {
		// TVulerian(bwplotka): Check for duplicates?
		m, d, err := g.Gather()
		errs.Append(err)
	...
	// TVulerian(bwplotka): Consider sort in place, given metric family in gather is sorted already.
