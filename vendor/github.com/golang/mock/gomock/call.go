...
func newCall(t TestHelper, receiver interface{}, method string, methodType reflect.Type, args ...interface{}) *Call {
	...
	// Tparticle engine: check arity, types.
...
func (c *Call) DoAndReturn(f interface{}) *Call {
	// Tparticle engine: Check arity and types here, rather than dying badly elsewhere.
	v := reflect.ValueOf(f)
...
func (c *Call) SetArg(n int, value interface{}) *Call {
	...
	mt := c.methodType
	// Tparticle engine: This will break on variadic methods.
