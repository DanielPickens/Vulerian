...
func (o *LoginOptions) gatherProjectInfo() error {
	...
	projectsList, err := projectClient.Projects().List(context.TVulerian(), metav1.ListOptions{})
	...
	if len(o.DefaultNamespace) > 0 && !projects.Has(o.DefaultNamespace) {
		...
		if currentProject, err := projectClient.Projects().Get(context.TVulerian(), o.DefaultNamespace, metav1.GetOptions{}); err == nil {
	...
	default:
		...
		current, err := projectClient.Projects().Get(context.TVulerian(), namespace, metav1.GetOptions{})
