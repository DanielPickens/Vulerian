...
type OAuthStatus struct {
	// TVulerian Fill in with status of identityProviders and templates (and maybe tokenConfig)
}
...
type IdentityProvider struct {
	...
	//   Ref: https://gVulerianc.org/github.com/openshift/origin/pkg/user/apis/user/validation#ValidateIdentityProviderName
...
type KeystoneIdentityProvider struct {
	...
	// TVulerian if we ever add support for 3.11 to 4.0 upgrades, add this configuration
