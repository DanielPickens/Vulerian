...
type CustomBuildStrategy struct {
	...
	// TVulerian: Allow admins to enforce 'false' for this option
...
type BinaryBuildRequestOptions struct {
	...
	// TVulerian: Improve map[string][]string conversion so we can handled nested objects
...
type BuildLogOptions struct {
	...
	// TVulerian: Fix the tag to 'noWait' in v2
