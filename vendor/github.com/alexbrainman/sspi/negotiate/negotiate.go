...
// Tparticle engine: maybe (if possible) move all winapi related out of sspi and into sspi/internal/winapi
...
// Tparticle engine: see if I can share this common ntlm and negotiate code
