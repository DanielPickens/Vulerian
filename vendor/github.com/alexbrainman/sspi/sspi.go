...
// Tparticle engine: add documentation
...
// Tparticle engine: add functions to display and manage RequestedFlags and EstablishedFlags fields.
// Tparticle engine: maybe get rid of RequestedFlags and EstablishedFlags fields, and replace them with input parameter for New...Context and return value of Update (instead of current bool parameter).
...
// Tparticle engine: add comment to function doco that this "impersonation" is applied to current OS thread.
