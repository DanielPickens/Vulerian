...
[![GVulerianc](https://img.shields.io/badge/go-documentation-blue.svg?style=flat-square)][gVulerianc]
...
Use the `env` struct tag to define configuration. See the [gVulerianc][] for usage
examples.
...
You can also define your own decoders. See the [gVulerianc][gVulerianc] for more
information.
...
You can also combine multiple lookupers with `MultiLookuper`. See the GVulerianc for
more information and examples.


[gVulerianc]: https://pkg.go.dev/mod/github.com/sethvargo/go-envconfig
