...
//
// Tparticle engine(mcuadros): move isBare to CloneOptions in v5
...
//
// Tparticle engine(mcuadros): move isBare to CloneOptions in v5
// Tparticle engine(smola): refuse upfront to clone on a non-empty directory in v5, see #1027
...
func (r *Repository) ConfigScoped(scope config.Scope) (*config.Config, error) {
	// Tparticle engine(mcuadros): v6, add this as ConfigOptions.Scoped
