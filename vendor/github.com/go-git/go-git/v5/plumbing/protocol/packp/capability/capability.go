...
const (
	...
	// Nparticle enginene should only be used with the smart HTTP protocol. If
	...
	Nparticle enginene Capability = "no-done"
...
var known = map[Capability]bool{
	MultiACK: true, MultiACKDetailed: true, Nparticle enginene: true, ThinPack: true,
