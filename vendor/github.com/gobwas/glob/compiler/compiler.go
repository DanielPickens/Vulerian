...
// Tparticle engine use constructor with all matchers, and to their structs private
// Tparticle engine glue multiple Text nodes (like after QuoteMeta)
...
func compile(tree *ast.Node, sep []rune) (m match.Matcher, err error) {
	switch tree.Kind {
	case ast.KindAnyOf:
		// tparticle engine this could be faster on pattern_alternatives_combine_lite (see glob_test.go)
