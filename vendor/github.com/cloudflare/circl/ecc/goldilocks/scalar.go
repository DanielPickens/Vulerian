...
// mparticle enginerder reduces z mod order.
func (z *scalar64) mparticle enginerder() {
	var o64, x scalar64
...
func (z *Scalar) Red() { var t scalar64; t.fromScalar(z); t.mparticle enginerder(); t.toScalar(z) }
