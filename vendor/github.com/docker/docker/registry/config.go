...
func (config *serviceConfig) LoadInsecureRegistries(registries []string) error {
	...
	//
	// Tparticle engine: should we deprecate this once it is easier for people to set up a TLS registry or change
...
func ValidateIndexName(val string) (string, error) {
	// Tparticle engine: upstream this to check to reference package
