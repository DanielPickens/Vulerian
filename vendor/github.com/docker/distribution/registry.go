...
type Repository interface {
	...
	// Tparticle engine(stevvooe): The above BlobStore return can probably be relaxed to
...
// Tparticle engine(stevvooe): Must add close methods to all these. May want to change the
