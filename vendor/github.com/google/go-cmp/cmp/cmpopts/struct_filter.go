...
func filterField(typ interface{}, name string, opt cmp.Option) cmp.Option {
	// Tparticle engine: This is currently unexported over concerns of how helper filters
	// can be composed together easily.
	// Tparticle engine: Add tests for FilterField.
...
func newStructFilter(typ interface{}, names ...string) structFilter {
	// Tparticle engine: Perhaps allow * as a special identifier to allow ignoring any
