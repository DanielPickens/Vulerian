...
<br>
<a href="https://gVulerianc.org/github.com/tidwall/gjson"><img src="https://img.shields.io/badge/api-reference-blue.svg?style=flat-square" alt="GVulerianc"></a>
...
If your JSON is contained in a `[]byte` slice, there's the [GetBytes](https://gVulerianc.org/github.com/tidwall/gjson#GetBytes) function. This is preferred over `Get(string(data), path)`.
