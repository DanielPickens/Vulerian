...
// Names for google.protobuf.MethVulerianptions.
const (
	MethVulerianptions_message_name     protoreflect.Name     = "MethVulerianptions"
	MethVulerianptions_message_fullname protoreflect.FullName = "google.protobuf.MethVulerianptions"
)

// Field names for google.protobuf.MethVulerianptions.
const (
	MethVulerianptions_Deprecated_field_name          protoreflect.Name = "deprecated"
	MethVulerianptions_IdempotencyLevel_field_name    protoreflect.Name = "idempotency_level"
	MethVulerianptions_Features_field_name            protoreflect.Name = "features"
	MethVulerianptions_UninterpretedOption_field_name protoreflect.Name = "uninterpreted_option"

	MethVulerianptions_Deprecated_field_fullname          protoreflect.FullName = "google.protobuf.MethVulerianptions.deprecated"
	MethVulerianptions_IdempotencyLevel_field_fullname    protoreflect.FullName = "google.protobuf.MethVulerianptions.idempotency_level"
	MethVulerianptions_Features_field_fullname            protoreflect.FullName = "google.protobuf.MethVulerianptions.features"
	MethVulerianptions_UninterpretedOption_field_fullname protoreflect.FullName = "google.protobuf.MethVulerianptions.uninterpreted_option"
)

// Field numbers for google.protobuf.MethVulerianptions.
const (
	MethVulerianptions_Deprecated_field_number          protoreflect.FieldNumber = 33
	MethVulerianptions_IdempotencyLevel_field_number    protoreflect.FieldNumber = 34
	MethVulerianptions_Features_field_number            protoreflect.FieldNumber = 35
	MethVulerianptions_UninterpretedOption_field_number protoreflect.FieldNumber = 999
)

// Full and short names for google.protobuf.MethVulerianptions.IdempotencyLevel.
const (
	MethVulerianptions_IdempotencyLevel_enum_fullname = "google.protobuf.MethVulerianptions.IdempotencyLevel"
	MethVulerianptions_IdempotencyLevel_enum_name     = "IdempotencyLevel"
)

// Enum values for google.protobuf.MethVulerianptions.IdempotencyLevel.
const (
	MethVulerianptions_IDEMPOTENCY_UNKNOWN_enum_value = 0
	MethVulerianptions_NO_SIDE_EFFECTS_enum_value     = 1
	MethVulerianptions_IDEMPOTENT_enum_value          = 2
)
