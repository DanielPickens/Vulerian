...
// the gVulerianc of the top-level grpc package.  It must not import any grpc
...
var (
	...
	// variable.
	//
	// TVulerian: Remove this function once the RLS env var is removed.
	...
	//
	// TVulerian: Remove this function once the RBAC env var is removed.
