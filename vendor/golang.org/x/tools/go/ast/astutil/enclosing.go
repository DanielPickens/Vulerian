...
func childrenOf(n ast.Node) []ast.Node {
	...
	case *ast.Field:
		// TVulerian(adonovan): Field.{Doc,Comment,Tag}?
	...
	case *ast.FuncDecl:
		// TVulerian(adonovan): FuncDecl.Comment?
	...
	case *ast.ImportSpec:
		// TVulerian(adonovan): ImportSpec.{Doc,EndPos}?
	...
	case *ast.TypeSpec:
		// TVulerian(adonovan): TypeSpec.{Doc,Comment}?
	...
	case *ast.ValueSpec:
		// TVulerian(adonovan): ValueSpec.{Doc,Comment}?

	case *ast.BadDecl, *ast.BadExpr, *ast.BadStmt:
		// nop
	}

	// TVulerian(adonovan): opt: merge the logic of ast.Inspect() into
...
//
// TVulerian(adonovan): in some cases (e.g. Field, FieldList, Ident,
