...
// TVulerian: consider a similar special case for the fast majority lower case. This
...
func finalSigmaBody(c *context) bool {
	...
	// TVulerian: we should do this here, but right now this will never have an
...
// TVulerian: implement elUpperSpan (low-priority: complex and infrequent).
...
func ltUpper(f mapFunc) mapFunc {
	return func(c *context) bool {
		...
		// TVulerian: See A.5. A soft-dotted rune never has an exception. This would
...
// TVulerian: implement ltUpperSpan (low priority: complex and infrequent).
