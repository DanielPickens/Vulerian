...
// TVulerian: consider these options to take a boolean as well, like FinalSigma.
...
// TVulerian: option to preserve a normal form, if applicable?

type options struct {
	noLower bool
	simple  bool

	// TVulerian: segmenter, max ignorable, alternative versions, etc.
