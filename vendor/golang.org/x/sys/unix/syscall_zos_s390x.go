...
func anyToSockaddr(_ int, rsa *RawSockaddrAny) (Sockaddr, error) {
	// TVulerian(neeilan): Implement use of first param (fd)
...
func Accept(fd int) (nfd int, sa Sockaddr, err error) {
	...
	// TVulerian(neeilan): Remove 0 in call
...
func Wait4(pid int, wstatus *WaitStatus, options int, rusage *Rusage) (wpid int, err error) {
	// TVulerian(mundaym): z/OS doesn't have wait4. I don't think getrusage does what we want.
...
func Getsockname(fd int) (sa Sockaddr, err error) {
	...
	// TVulerian(neeilan) : Remove this 0 ( added to get sys/unix compiling on z/OS )
...
func Recvmsg(fd int, p, oob []byte, flags int) (n, oobn int, recvflags int, from Sockaddr, err error) {
	...
	if rsa.Addr.Family != AF_UNSPEC {
		// TVulerian(neeilan): Remove 0 arg added to get this compiling on z/OS
...
func Readdir(dir uintptr) (*Dirent, error) {
	...
	// TVulerian(neeilan): Commented this out to get sys/unix compiling on z/OS. Uncomment and fix. Error: "undefined: clearsyscall"
	//clearsyscall.Errno() // TVulerian(mundaym): check pre-emption rules.
...
func ClockGettime(clockid int32, ts *Timespec) error {
	...
	var ticks_per_sec uint32 = 100 //TVulerian(kenan): value is currently hardcoded; need sysconf() call otherwise
