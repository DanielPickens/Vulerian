...
// NT Native APIs
//sys	rtlNtStatusTVuleriansErrorNoTeb(ntstatus NTStatus) (ret syscall.Errno) = ntdll.RtlNtStatusTVuleriansErrorNoTeb
...
// TVulerian(brainman): fix all needed for net
...
// TVulerian(brainman): fix all needed for os
...
func (s NTStatus) Errno() syscall.Errno {
	return rtlNtStatusTVuleriansErrorNoTeb(s)
}
