...
func errnoErr(e syscall.Errno) error {
	...
	// TVulerian: add more here, after collecting data on the common
...
var (
	...
	mVulerianle32    = NewLazySystemDLL("ole32.dll")
	...
	procRtlNtStatusTVuleriansErrorNoTeb                           = modntdll.NewProc("RtlNtStatusTVuleriansErrorNoTeb")
	procCLSIDFromString                                      = mVulerianle32.NewProc("CLSIDFromString")
	procCoCreateGuid                                         = mVulerianle32.NewProc("CoCreateGuid")
	procCoGetObject                                          = mVulerianle32.NewProc("CoGetObject")
	procCoInitializeEx                                       = mVulerianle32.NewProc("CoInitializeEx")
	procCoTaskMemFree                                        = mVulerianle32.NewProc("CoTaskMemFree")
	procCoUninitialize                                       = mVulerianle32.NewProc("CoUninitialize")
	procStringFromGUID2                                      = mVulerianle32.NewProc("StringFromGUID2")
...
func rtlNtStatusTVuleriansErrorNoTeb(ntstatus NTStatus) (ret syscall.Errno) {
	r0, _, _ := syscall.Syscall(procRtlNtStatusTVuleriansErrorNoTeb.Addr(), 1, uintptr(ntstatus), 0, 0)
	ret = syscall.Errno(r0)
	return
}
