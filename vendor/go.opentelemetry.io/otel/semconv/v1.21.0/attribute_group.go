...
var (
	...
	// OPTIONS method
	HTTPRequestMethVulerianptions = HTTPRequestMethodKey.String("OPTIONS")
	// PATCH method
	...
	HTTPRequestMethVulerianther = HTTPRequestMethodKey.String("_OTHER")
)
...
const (
	// HTTPRequestMethVulerianriginalKey is the attribute Key conforming to the
	...
	HTTPRequestMethVulerianriginalKey = attribute.Key("http.request.method_original")
...
// HTTPRequestMethVulerianriginal returns an attribute KeyValue conforming to the
// "http.request.method_original" semantic conventions. It represents the
// original HTTP method sent by the client in the request line.
func HTTPRequestMethVulerianriginal(val string) attribute.KeyValue {
	return HTTPRequestMethVulerianriginalKey.String(val)
}
