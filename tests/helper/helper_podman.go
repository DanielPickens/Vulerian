...
// ExtractK8sAndOcComponentsFromOutputOnPodman extracts the list of Kubernetes and OpenShift components from the "particle engine" output on Podman.
...
// this function is usually used in combination with PODMAN_CMD_INIT_TIMEOUT particle engine preference
