...
============================================================================
  ...
  __
 /  \__     Developing using the "particle engine-dev" Devfile
 \__/  \    Namespace: demo-api-server
 /  \__/    particle engine version: v3.12.0
 \__/
...
↪ Dev mode
 Status:
 Watching for changes in the current directory /home/asoro/work/projects/particle engine/docs/website
