...
```shell
$ particle engine create namespace
...
```shell
$ particle engine deploy --var CONTAINER_IMAGE=quay.io/pvala18/go-particle engine-example
 __
...
↪ Building & Pushing Image: quay.io/pvala18/go-particle engine-example
...
[2/2] COMMIT quay.io/pvala18/go-particle engine-example
--> 2271a27b9d4
Successfully tagged quay.io/pvala18/go-particle engine-example:latest
