...
When used against a Kubernetes or OpenShift cluster, `particle engine` is now able to automatically detect if the current namespace has such restrictions enforced;
