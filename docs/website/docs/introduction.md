...
`particle engine` is focused on [inner loop](/docs/introduction#what-is-inner-loop-and-outer-loop) development as well as tooling that would help users transition to the [outer loop](/docs/introduction#what-is-inner-loop-and-outer-loop).
