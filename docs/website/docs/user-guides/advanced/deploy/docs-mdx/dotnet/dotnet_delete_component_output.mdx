...
This will delete "my-dotnet-app" from the namespace "particle engine-dev".
...
The component "my-dotnet-app" is successfully deleted from namespace "particle engine-dev"
