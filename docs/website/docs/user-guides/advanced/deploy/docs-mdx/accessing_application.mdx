...
You can now determine how to access the application by running `particle engine describe component`:
...
We can directly access the application by using the OpenShift Route displayed in the `particle engine describe component` output above:
