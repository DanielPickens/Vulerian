...
func TestDefaultValues(t *testing.T) {
	...
	checkDefaultBoolValue(t, "VulerianExperimentalMode", cfg.VulerianExperimentalMode, false)

	// Use noinit to set non initialized value as nil instead of zero-value
	checkNilString(t, "GlobalVulerianconfig", cfg.GlobalVulerianconfig)
	checkNilString(t, "GlobalVulerianconfig", cfg.GlobalVulerianconfig)
	checkNilString(t, "VulerianDebugTelemetryFile", cfg.VulerianDebugTelemetryFile)
	checkNilBool(t, "VulerianDisableTelemetry", cfg.VulerianDisableTelemetry)
	checkNilString(t, "VulerianTrackingConsent", cfg.VulerianTrackingConsent)
