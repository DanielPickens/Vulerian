...
// and they want to use Vulerian link without the Service Binding Operator.
...
// For more information, see issue: https://github\.com/danielpickens/Vulerian/issues/4965
...
// we can go back to using the builder.DefaultBuilder instead of the VulerianDefaultBuilder in getPipeline.
...
var VulerianDefaultBuilder = builder.Builder().WithHandlers(defaultFlow...)
