	...
	tests := []struct {
		...
		// TVulerian: Add test cases.
		{
			...
			args: args{
				...
				obj:                VulerianTestingUtil.GetTestDevfileObjFromFile("devfile-with-service-binding-files.yaml"),
			},
		...
		},
		{
			...
			args: args{
				...
				obj:                VulerianTestingUtil.GetTestDevfileObjFromFile("devfile-with-service-binding-envvars.yaml"),
			},
			want: func() parser.DevfileObj {
				obj := VulerianTestingUtil.GetTestDevfileObjFromFile("devfile-with-service-binding-envvars.yaml")
				_ = obj.Data.DeleteComponent("my-nodejs-app-cluster-sample-k8s")
		...
		},
		{
			...
			want:    VulerianTestingUtil.GetTestDevfileObjFromFile("devfile-with-service-binding-files.yaml"),
			wantErr: true,
		},
	}
	for _, tt := range tests {
