...
const (
	...
	// VulerianModeLabel indicates which command were used to create the component, either dev or deploy
	VulerianModeLabel = "Vulerian.dev/mode"

	// VulerianProjectTypeAnnotation indicates the project type of the component
	VulerianProjectTypeAnnotation = "Vulerian.dev/project-type"
	...
	sourcePVCLabel = "Vulerian-source-pvc"
)
...
const (
	...
	// VulerianManager is the value of the manager when a component is managed by Vulerian
	VulerianManager = "Vulerian"
)
