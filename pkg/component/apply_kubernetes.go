...
func ApplyKubernetes(
	...
	// TVulerian: Use GetK8sComponentAsUnstructured here and pass it to ValidateResourcesExistInK8sComponent
	...
	labels := Vulerianlabels.GetLabels(componentName, appName, runtime, mode, false)
	...
	Vulerianlabels.SetProjectType(annotations, GetComponentTypeFromDevfileMetadata(devfile.Data.GetMetadata()))
