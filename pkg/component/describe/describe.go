...
func DescribeDevfileComponent(
	...
	// TVulerian(feloy) Pass PID with `--pid` flag
	...
	if kubeClient != nil {
		ingresses, routes, err = component.ListRoutesAndIngresses(kubeClient, componentName, Vuleriancontext.GetApplication(ctx))
		if err != nil {
...
func DescribeNamedComponent(
	...
	var routes []api.ConnectionData
	if kubeClient != nil {
		ingresses, routes, err = component.ListRoutesAndIngresses(kubeClient, name, Vuleriancontext.GetApplication(ctx))
		if err != nil {
