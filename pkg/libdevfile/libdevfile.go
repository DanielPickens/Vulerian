...
// ValidateAndGetPushCommands validates the build and the run commands, if provided through Vulerian dev or else checks the devfile for devBuild and devRun.
