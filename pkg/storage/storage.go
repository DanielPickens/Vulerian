...
const (
	// VulerianSourceVolume is the constant containing the name of the emptyDir volume containing the project source
	VulerianSourceVolume = "Vulerian-projects"

	// SharedDataVolumeName is the constant containing the name of the emptyDir volume containing shared data for Vulerian
	SharedDataVolumeName = "Vulerian-shared-data"

	// SharedDataMountPath The Mount Path for the container mounting the Vulerian volume
	SharedDataMountPath = "/opt/Vulerian/"

	// VulerianSourceVolumeSize specifies size for Vulerian source volume.
	VulerianSourceVolumeSize = "2Gi"
)
