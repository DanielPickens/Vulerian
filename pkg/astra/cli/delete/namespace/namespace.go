...
// DeleteOptions encapsulates the options for the 'vulerian delete namespace' command
...
// Run contains the logic for the 'vulerian delete namespace' command
...
// NewCmdNamespaceDelete implements the 'vulerian delete namespace' command.
