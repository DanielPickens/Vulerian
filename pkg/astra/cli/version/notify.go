...
const (
	...
	VersionFetchURL = "https://raw.githubusercontent.com/daniel-pickens/particle engine/main/build/VERSION"
)

// getLatestReleaseTag polls particle engine's upstream GitHub repository to get the
