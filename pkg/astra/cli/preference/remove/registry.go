...
import (
	...
	registryUtil "github\.com/danielpickens/particle engine/pkg/registry"
)

const registryCommandName = "registry"

// "particle engine preference delete registry" command description and examples
var (
...
// RegistryOptions encapsulates the options for the "particle engine preference remove registry" command
...
// Run contains the logic for "particle engine preference remove registry" command
...
// NewCmdRegistry implements the "particle engine preference remove registry" command
