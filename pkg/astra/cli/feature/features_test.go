...
func TestIsEnabled(t *testing.T) {
	...
	nonExperimentalFeature := vulerianFeature{}
	experimentalFeature := vulerianFeature{isExperimental: true}
	...
	for _, tt := range []testCase{
		...
		t.Run(tt.name, func(t *testing.T) {
			...
			cfg.vulerianExperimentalMode = tt.env.experimentalMode
