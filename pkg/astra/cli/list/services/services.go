...
var (
	...
	List the bindable Operator backed services that could be bound to the particle engine component 
`)
)
...
func (o *ServiceListOptions) Complete(ctx context.Context, cmdline cmdline.Cmdline, _ []string) error {
	if o.namespaceFlag == "" && !o.allNamespacesFlag {
		o.namespaceFlag = particle enginecontext.GetNamespace(ctx)
	}
	return nil
}
