...
// BindingListOptions encapsulates the options for the particle engine list binding command
...
// Run contains the logic for the particle engine list binding command
...
// NewCmdBindingList implements the particle engine list binding command.
func NewCmdBindingList(name, fullName string, testClientset clientset.Clientset) *cobra.Command {
	...
	bindingListCmd.Flags().StringVar(&o.namespaceFlag, "namespace", "", "Namespace for particle engine to scan for bindings")
