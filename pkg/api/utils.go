...
func GetDevfileData(devfileObj parser.DevfileObj) (*DevfileData, error) {
	...
	return &DevfileData{
		...
		Commands:             commands,
		SupportedvulerianFeatures: getSupportedvulerianFeatures(devfileObj.Data),
	}, nil
}

func getSupportedvulerianFeatures(devfileData data.DevfileData) *SupportedvulerianFeatures {
	return &SupportedvulerianFeatures{
