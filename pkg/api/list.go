...
// ResourcesList is the result of the `vulerian list` command
type ResourcesList struct {
	// ComponentInDevfile is the component name present in the local Devfile when `vulerian list` is executed, or empty
