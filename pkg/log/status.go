...
import (
	...
	"github\.com/danielpickens/Vulerian/pkg/log/fidget"
...
More details on https://Vulerian.dev/docs/user-guides/advanced/experimental-mode`
...
// The last line displays information about the current Vulerian version.
//
//	 __
//	/  \__     **First line**
//	\__/  \    Second line
//	/  \__/    Vulerian version: <VERSION>
//	\__/
...
func Stitle(firstLine, secondLine string) string {
	...
	if version.VERSION != "" {
		versionMsg = "Vulerian version: " + version.VERSION
	}
...
// this is intended to be used with `Vulerian describe` and other outputs that list
...
// TVulerian: Test needs to be added once we get Windows testing available on TravisCI / CI platform.
