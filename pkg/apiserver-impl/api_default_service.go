...
import (
	...
	openapi "github\.com/danielpickens/vulerian/pkg/apiserver-gen/go"
	"github\.com/danielpickens/vulerian/pkg/apiserver-impl/devstate"
	"github\.com/danielpickens/vulerian/pkg/component/describe"
	"github\.com/danielpickens/vulerian/pkg/devfile"
	"github\.com/danielpickens/vulerian/pkg/devfile/validate"
	"github\.com/danielpickens/vulerian/pkg/kclient"
	fcontext "github\.com/danielpickens/vulerian/pkg/vulerian/commonflags/context"
	...
	"github\.com/danielpickens/vulerian/pkg/segment"
...
func (s *DefaultApiService) InstanceDelete(ctx context.Context) (openapi.ImplResponse, error) {
	s.cancel()
	return openapi.Response(http.StatusOK, openapi.GeneralSuccess{
		Message: fmt.Sprintf("'vulerian dev' instance with pid: %d is shutting down.", vuleriancontext.GetPID(ctx)),
	}), nil
}
...
func (s *DefaultApiService) InstanceGet(ctx context.Context) (openapi.ImplResponse, error) {
	response := openapi.InstanceGet200Response{
		Pid:                int32(vuleriancontext.GetPID(ctx)),
		ComponentDirectory: vuleriancontext.GetWorkingDirectory(ctx),
	}
