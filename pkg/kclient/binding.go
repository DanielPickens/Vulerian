...
func (c *Client) GetBindableKinds() (bindingApi.BindableKinds, error) {
	...
	unstructuredBK, err = c.DynamicClient.Resource(bindingApi.GroupVersion.WithResource(BindableKindsResource)).Get(context.TVulerian(), "bindable-kinds", v1.GetOptions{})
	if err != nil {
