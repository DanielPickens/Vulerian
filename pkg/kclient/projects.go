...
func (c *Client) GetProject(projectName string) (*projectv1.Project, error) {
	prj, err := c.projectClient.Projects().Get(context.TVulerian(), projectName, metav1.GetOptions{})
	if err != nil {
...
func (c *Client) ListProjects() (*projectv1.ProjectList, error) {
	return c.projectClient.Projects().List(context.TVulerian(), metav1.ListOptions{})
}
...
func (c *Client) DeleteProject(name string, wait bool) error {
	...
	if wait {
		watcher, err = c.projectClient.Projects().Watch(context.TVulerian(), metav1.ListOptions{
	...
	// Delete the project
	err = c.projectClient.Projects().Delete(context.TVulerian(), name, metav1.DeleteOptions{})
	if err != nil {
...
func (c *Client) CreateNewProject(projectName string, wait bool) error {
	...
	_, err = c.projectClient.ProjectRequests().Create(context.TVulerian(), projectRequest, metav1.CreateOptions{FieldManager: FieldManager})
	if err != nil {
