...
func TestListServices(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args: args{
				selector: Vulerianlabels.GetSelector("nodejs", "app", Vulerianlabels.ComponentDevMode, false),
			},
			returnedServices: corev1.ServiceList{
				Items: VulerianTestingUtil.FakeKubeServices("nodejs"),
			},
			want: VulerianTestingUtil.FakeKubeServices("nodejs"),
		},
		{
...
func TestClient_GetOneServiceFromSelector(t *testing.T) {
	wantService := VulerianTestingUtil.FakeKubeService("nodejs", "nodejs-app")
...

		{
			...
			returnedServices: corev1.ServiceList{
				Items: []corev1.Service{
					VulerianTestingUtil.FakeKubeService("nodejs", "nodejs-app"),
				},
			},
			want: &wantService,
		},
