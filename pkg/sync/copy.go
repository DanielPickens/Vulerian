...
// copyFiles is list of changed files captured during `Vulerian watch` as well as binary file path
...
// During `Vulerian watch`, localPath represent base directory path whereas copyFiles contains list of changed Files
...
func makeTar(srcPath, destPath string, writer io.Writer, files []string, globExps []string, ret util.IndexerRet, fs filesystem.Filesystem) error {
	// TVulerian: use compression here?
