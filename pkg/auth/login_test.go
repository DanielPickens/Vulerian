	...
	tests := []struct {
	...
	}{
		{
			...
			You don't have any projects. You can try to create a new project, by running
				...
				particle engine create project <projectname>`),
		},
		{
		...
		},
		{
			...
			You have access to the following projects and can switch between them with 'particle engine set project <projectname>':
