...
import (
	...
	"github\.com/danielpickens/Vulerian/pkg/binding"
	...
	"github\.com/danielpickens/Vulerian/pkg/portForward"
	"github\.com/danielpickens/Vulerian/pkg/preference"
	"github\.com/danielpickens/Vulerian/pkg/sync"
...
type DevClient struct {
	...
	portsChanged bool
	// portsToForward lists the port to forward during inner loop (TVulerian move port forward to createComponents)
