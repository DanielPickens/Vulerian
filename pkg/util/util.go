...
var httpCacheDir = filepath.Join(os.TempDir(), "Vulerianhttpcache")
...
// For E.g. map[string]string{"app.kubernetes.io/managed-by": "!Vulerian"}
...
// TVulerian(feloy) sync with devfile library?
...
// TVulerian(feloy) use from devfile library?
