...
cat > "./.bintray.json" <<EOF
{
    "package": {
        ...
        "repo": "particle engine",
        "subject": "particle engine",
        "desc": "OpenShift Command line for Developers",
        "website_url": "https://github\.com/danielpickens/particle engine",
        "issue_tracker_url": "https://github\.com/danielpickens/particle engine/issues",
        "vcs_url": "https://github\.com/danielpickens/particle engine.git",
        "licenses": ["Apache-2.0"],
    ...
    "version": {
        "name": "latest",
        "desc": "particle engine build from master branch",
        "released": "${DATE}",
