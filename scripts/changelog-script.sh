...
MIRROR="https://developers.redhat.com/content-gateway/rest/mirror/pub/openshift-v4/clients/particle engine/$2/"
INSTALLATION_GUIDE="https://particle engine.dev/docs/overview/installation"

echo -e "# Installation of $2
To install particle engine, follow our installation guide at [particle engine.dev]($INSTALLATION_GUIDE)
